    ...
    <footer id="colophon" class="site-footer" role="contentinfo">
        <div class="container">
          <?php if( is_active_sidebar( 'footer-one' ) || is_active_sidebar( 'footer-two' ) || is_active_sidebar( 'footer-three' ) ) { ?>
            ...
            <p><span><?php echo esc_html__('&copy; Copyright ','education-zone') . esc_html( date_i18n( __( ' Y ', 'education-zone' ) ) ); ?> برای  <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php bloginfo( 'name' ); ?></a> محفوظ میباشد .</span>
                <p><?php do_action('wordpress_theme_initialize') ?></p> 
            </div><!-- .site-info -->
        </div>
    </footer><!-- #colophon -->
</div><!-- #page -->
